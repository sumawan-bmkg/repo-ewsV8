...
| False Negatives (FN) | 2,218 |
| **Accuracy** | **0.2271** |
| **Precision** | **0.9871** |
| **Recall (Sensitivity)** | **0.2168** |
| **Specificity** | **0.8333** |
| **F2-Score** | **0.2569** |
| **AUPRC** | **0.9848** |
| AUC-ROC | 0.4640 |
...
|       0.1   | 2485 |   45 |    3 |  347 |   0.8775 |      0.9822 | 0.8966 | 0.9375 |       |
|       0.15  | 1368 |   26 |   22 | 1464 |   0.4831 |      0.9813 | 0.5377 | 0.5417 |       |
|       0.2   |  737 |   16 |   32 | 2095 |   0.2602 |      0.9788 | 0.305  | 0.3333 |       |
|       0.25  |  549 |    2 |   46 | 2283 |   0.1939 |      0.9964 | 0.2311 | 0.0417 |       |
|       0.3   |  426 |    0 |   48 | 2406 |   0.1504 |      1      | 0.1812 | 0      |       |
|       0.225 |  614 |    8 |   40 | 2218 |   0.2168 |      0.9871 | 0.2569 | 0.1667 | ← OPT |
...
| Metric | Value |
|--------|-------|
| Spearman ρ (all) | 0.0342 (p=0.069012) |
| Spearman ρ (TP only) | 0.0342 (p=0.069012) |
| N pairs | 2,832 |
...
|:--------------------|:----------|------------:|----------------:|---------:|-----------:|----------:|----------:|
| 2026-03-31 00:00:00 | JYP       |      0.2675 |               0 |    2.667 |        nan |     89.24 |         0 |
| 2026-03-31 00:00:00 | SMI       |      0.2657 |               0 |    2.667 |        nan |     89.3  |         0 |
| 2026-03-31 00:00:00 | LWA       |      0.2479 |               0 |    2.667 |        nan |     88.92 |         0 |
...
1. **Detection**: The V8SupCon model does not achieve the 85% recall target with a Precision of 0.9871
